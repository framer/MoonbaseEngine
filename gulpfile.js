...
(function() {
  var Highlights, _, buildPath, changed, config, context, data, del, e, emptytask, error, execSync, express, filesInDir, fs, getTotalSizeForFileType, gulp, gulpif, gulpnunjucks, gutil, highlighter, imagemin, imageminOptions, isDirectory, join, livereload, lr, markdown, marked, md5, merge, minifycss, named, newy, nunjucks, nunjucksDate, nunjucksPipe, paths, plumber, portfinder, projectPath, purify, sass, sourcemaps, spritesmith, st, watch, webpack, webpackConfig, webpackConfigCoffeeScript, webpackConfigJavaScript, webpackConfigPlugins, workingPath;
  ...
  gulp.task("cleanCSS", function() {
    return gulp.src(buildPath(paths.scss, "style.css")).pipe(purify([buildPath(paths.javascript, "**/*.js"), buildPath("", "**/*.html")], {
      rejected: true
    })).pipe(gulp.dest(buildPath("clean")));
  });
